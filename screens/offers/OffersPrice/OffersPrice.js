            ...
            >
                ...
                <Animated.View
                    ...
                    <View
                        ...
                        <Text style={{ fontSize: 20, fontWeight: '300', marginLeft: 7, color: 'black' }}>
                            Done
                        </Text>
                    </View>
                    <View>
                                ...
                                <View style={styles.offersRowItem}>
                                    ...
                                    <View style={styles.offersItemOuter2}>
                                        ...
                                        <View style={styles.offersInvoiceiconwrap}>
                                            ...
                                            <Image source={require('../../../assets/icon/dollar-sign1.png')} style={styles.btnImg} />
                                        </View>
...
const styles = StyleSheet.create({
    ...
    addbtn: {
        ...
        alignItems: 'center',
        alignSelf: 'center',
        backgroundColor: colors.addItemBtnColor,
        elevation: 5,
        borderRadius: 7,
